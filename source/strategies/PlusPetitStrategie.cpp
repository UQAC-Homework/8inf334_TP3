...
strategies::PlusPetitStrategie::PlusPetitStrategie(const std::string& left, const std::string& right)
{
	this->left = left;
	this->right = right;
}

bool strategies::PlusPetitStrategie::execute(Contexte& contexte)
{
